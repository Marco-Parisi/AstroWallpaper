...
{
    public class ESOParser : IParser
    {
        public string ParserName => "ESOParser";
        ...
        public async Task<string> GetImageUrl()
        {
            try
            {
                ...
                string baseUrl = "https://www.eso.org/public/images/archive/";
                ...
                string firstPageHtml = await client.GetStringAsync(baseUrl + "/list/1");
                ...
                baseUrl = baseUrl + "/list/" + randomPage + "/?sort=-release_date";
